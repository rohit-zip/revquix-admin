...
export const NOTIFICATION_TYPE = {
  ...
  RESUME_REVIEW_ACCEPTED: "RESUME_REVIEW_ACCEPTED",
  RESUME_REVIEW_REPORT_READY: "RESUME_REVIEW_REPORT_READY",
  RESUME_REVIEW_CANCELLED: "RESUME_REVIEW_CANCELLED",
...
export const NOTIFICATION_TYPE_OPTIONS: { label: string; value: NotificationType }[] = [
  ...
  { label: "Resume Review Accepted", value: "RESUME_REVIEW_ACCEPTED" },
  { label: "Resume Review Report Ready", value: "RESUME_REVIEW_REPORT_READY" },
  { label: "Resume Review Cancelled", value: "RESUME_REVIEW_CANCELLED" },
